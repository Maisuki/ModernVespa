...
public class ResetPassServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if ((email == null || key == null || name == null)) {
        ...
        try {
            ...
            message.setSubject("Scooter Narcotics Account Reset");
            message.setRecipients(Message.RecipientType.TO, InternetAddress.parse(email));
            String msg = craftResetPasswordEmail(name, email, key);
    ...
    public static String craftResetPasswordEmail(String name, String email, String key) {
        String emailContent = "<!DOCTYPE html>\n"
                ...
                + "                        <br>\n"
                + "                        <p>Please click on the following link below to reset your password:</p>\n"
                + "                        <u>\n"
                + "                            <a href='https://scooter-narcotics.com/reset?verify=" + key + "'>https://scooter-narcotics.com/reset?verify=" + key + "</a>\n"
                + "                        </u>\n"
                + "                        <br><br>\n"
                + "                    </div>\n"
                + "                </div>\n"
