...
@WebServlet(name = "RetrieveOneZombieServlet", urlPatterns = {"/retrieveZombie"})
public class RetrieveOneZombieServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String POST_URL = Global.BASE_URL + "/retrieveOneZombie";
