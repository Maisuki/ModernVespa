...
@WebServlet(name = "DeleteProductBrandServlet", urlPatterns = {"/deleteProductBrand"})
public class DeleteProductBrandServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String POST_URL = Global.BASE_URL + "/deleteProductBrand";
