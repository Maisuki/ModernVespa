...
<%
    String pageName = " | All Categories";
    String titleName = "All Categories";
    String reqUri = request.getRequestURI();
    String path = reqUri.substring(reqUri.lastIndexOf("/") + 1);
    String hyperlink = path;
    String breadCrumbName = "All Categories";
%>
<!DOCTYPE html>
<html>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                            <a href="addCat.jsp" class="btn btn-default">Add Category</a>
                        </div>
                    </div>
                    <br>
                    <div class="row">
