...
<%
    String pageName = " | All Brand & Models";
    String titleName = "All Brand & Models";
    String reqUri = request.getRequestURI();
    String path = reqUri.substring(reqUri.lastIndexOf("/") + 1);
    String hyperlink = path;
    String breadCrumbName = "All Brand & Models";
%>
<!DOCTYPE html>
<html>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                            <a href="addBM.jsp" class="btn btn-default">Add Brand and Model</a>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <table id="BMs" class="table table-hover">
                                        <thead>
                                            <tr>
                                                <th>Brand Name</th>
                                                <th>Model Name</th>
