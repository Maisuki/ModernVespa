...
<%
    String pageName = " | Choose related products";
    String titleName = "Add Product - Choose related products";
    String reqUri = request.getRequestURI();
    String path = reqUri.substring(reqUri.lastIndexOf("/") + 1);
    String query = request.getQueryString();
    String hyperlink = path + "?" + query;
    String breadCrumbName = "Choose related products";
%>
<!DOCTYPE html>
<html>
    ...
    <body class="hold-transition skin-maroon sidebar-mini">
        ...
        <script src="js/selectRelatedProducts.js"></script>
    </body>
</html>
