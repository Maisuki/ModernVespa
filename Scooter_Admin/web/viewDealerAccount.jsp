...
<%
    String pageName = " | All Dealer Accounts";
    String titleName = "All Dealer Accounts";
    String reqUri = request.getRequestURI();
    String path = reqUri.substring(reqUri.lastIndexOf("/") + 1);
    String hyperlink = path;
    String breadCrumbName = "All Dealer Accounts";
%>
<!DOCTYPE html>
<html>
    ...
    <body class="hold-transition skin-maroon sidebar-mini">
        ...
        <script src="js/viewDealerAccount.js"></script>
    </body>
</html>