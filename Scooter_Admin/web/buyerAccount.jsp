...
<%
    String pageName = " | Buyer Account Details";
    String titleName = "Buyer Account Details";
    String reqUri = request.getRequestURI();
    String path = reqUri.substring(reqUri.lastIndexOf("/") + 1);
    String hyperlink = path;
    String breadCrumbName = "Buyer Account Details";
%>
<!DOCTYPE html>
<html>
    ...
    <body class="hold-transition skin-maroon sidebar-mini">
        ...
        <script src="js/buyerAccount.js"></script>
    </body>
</html>