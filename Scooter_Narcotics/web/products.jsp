                            ...
                            <div class="grid-col grid-col-left grid-col-2" style="margin-top: -50px; margin-left: 15px;">
                                ...
                                <form>
                                    <div class="widget widget-categories-filter">
                                        <div class="select mobileDisplayOption" style="margin-bottom: -40px;margin-left: -30px;">
                                ...
                                <div id="loadContainer">
                                    <a id="load" href="#" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04">
                                        Load More
                                    </a>
                                </div>
                                ...
                                <div id="end">
                                    <span class="stext-110 dashes"></span>
                                </div>
                            </div>
                        </div>
