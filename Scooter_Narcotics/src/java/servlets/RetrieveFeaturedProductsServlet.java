...
@WebServlet(name = "RetrieveFeaturedProductsServlet", urlPatterns = {"/featuredProducts"})
public class RetrieveFeaturedProductsServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String GET_URL = Global.BASE_URL + "/featured";
