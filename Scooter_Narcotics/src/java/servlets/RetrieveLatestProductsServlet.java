...
@WebServlet(name = "RetrieveLatestProductsServlet", urlPatterns = {"/latestproducts"})
public class RetrieveLatestProductsServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String GET_URL = Global.BASE_URL + "/latestproducts";
