...
@WebServlet(name = "RemoveNotepadServlet", urlPatterns = {"/removeNp"})
public class RemoveNotepadServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String POST_PARAMS = "clientId=" + clientId + "&npId=" + notepadId + "&action=remove";
        ...
        if (!status) {
            ...
            JsonObject success = MessageHandler.successMessageGenerator("Successfully removed notepad...");
